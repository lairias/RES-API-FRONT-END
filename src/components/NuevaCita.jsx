...
const NuevaCita = (props) => {
    ...
    //Creamos un Objeto con los States donde se guardaren los datos de los imput
    ...
    //creando la peticion a al API
    const CrearNuevaCita = e =>{
        e.preventDefault();
        //envio de la pericion 
    ...
    return (
        <Fragment>
            <h1 className="my-5">Creat Nueva Cita</h1>
